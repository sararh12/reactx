...
const CoursesPage: React.FC = () => {
  ...
  const fetchCourses = () => {
    const { technologyIds, levelName, priceRange, courseRate, statusName } =
      selectedFilters;
  ...
  const paginate = (pageNumber: number) => {
    if (pageNumber >= 1 && (pageNumber - 1) * coursesPerPage < totalCount) {
            ...
            <div className="flex flex-col md:flex-row items-center justify-between">
              <div className="mb-6 md:mb-0">
                ...
                <p className="text-gray-700 mt-2">
                  به روز ترین دوره هایی که میتوانید پیدا کنید
                </p>
              </div>
          ...
          <div className="container mx-auto px-6">
            <div className="mb-6 lg:hidden">
              <button
                ...
                className="w-full flex items-center justify-center px-4 py-2 border border-gray-300 rounded-md shadow-sm bg-white text-base font-medium text-gray-700 hover:bg-gray-50"
              >
            ...
            <div className="flex flex-col lg:flex-row gap-8">
              {isFilterOpen && (
                <div
                  className="fixed flex top-0 left-0 w-full h-full bg-black bg-opacity-50 z-30 lg:hidden"
                  onClick={toggleFilterMenu}
                ></div>
              )}
              {/* Filters */}
              ...
              lg:static lg:w-1/4 lg:translate-x-0 lg:shadow-md lg:rounded-lg lg:h-auto`}
              >
                    ...
                    <div className="mb-6">
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center">
                          <Checkbox
                            id="status-published"
                            checked={selectedFilters.statusName.includes(
                              "published"
                            )}
                            onCheckedChange={() =>
                              handleFilterChange("statusName", "published")
                            }
                          />
                          <label
                        ...
                        <div className="flex items-center">
                          <Checkbox
                            ...
                            onCheckedChange={() =>
                              handleFilterChange("statusName", "presell")
                            }
                          />
                          <label
                            htmlFor="status-presell"
                            className="mr-2 text-sm cursor-pointer"
                          >
                            در حال پیش فروش
                          </label>
                        ...
                        <div className="flex items-center">
                          <Checkbox
                            ...
                            onCheckedChange={() =>
                              handleFilterChange("statusName", "completing")
                            }
                          />
                          <label
                            htmlFor="status-completing"
                            className="mr-2 text-sm cursor-pointer"
                          >
                            در حال تکمیل
                          </label>
                        ...
                        {[5, 4, 3, 2, 1].map((courseRate) => (
                          <div key={courseRate} className="flex items-center">
                            <Checkbox
                              ...
                              checked={selectedFilters.courseRate.includes(
                                courseRate
                              )}
                              onCheckedChange={() =>
                                handleFilterChange("courseRate", courseRate)
                              }
                            />
                            <label
                              htmlFor={`rating-${courseRate}`}
                              className="mr-2 text-sm flex items-center cursor-pointer"
                            >
                              <span className="text-yellow-500">
                                {Array(courseRate).fill("★").join("")}
                              </span>
                      ...
                      <div className="space-y-2">
                        {[
                          ...
                          <div key={level.id} className="flex items-center">
                            <Checkbox
                              id={`level-${level.id}`}
                              checked={selectedFilters.levelName.includes(
                                level.id
                              )}
                              onCheckedChange={() =>
                    ...
                    <div>
                      ...
                      <div className="mt-4">
                        ...
                        <div className="flex justify-between text-sm text-gray-600 mt-2">
                          <span>۰ تومان</span>
                          <span>
                            {formatPrice(selectedFilters.priceRange)} تومان
                          </span>
                        </div>
                      </div>
                    </div>
                ...
                {courses.length > 0 ? (
                  ...
                  <div className="text-center py-12">
                    <h3 className="text-xl font-bold text-gray-700 mb-2">
                      هیچ دوره ای با این مشخصات پیدا نشد
                    </h3>
                    <p className="text-gray-500">
                      لطفا فیلترهای خود را تغییر دهید یا از عبارت جستجوی دیگری
                      استفاده کنید
                    </p>
                    <button
                ...
                {totalCount > coursesPerPage && (
                  <div className="flex justify-center mt-8">
                    ...
                    <span className="text-sm text-gray-500">
                      صفحه {currentPage} از{" "}
                      {Math.ceil(totalCount / coursesPerPage)}
                    </span>
