...
const initialCourses = [
  ...
  // Duplicate courses with different properties to have more for filtering
  {
    id: '5',
    title: 'آموزش مقدماتی Bootstrap',
    instructor: 'علی محمدی',
    rating: 4.3,
    students: 850,
    price: 0,
  ...
  {
    id: '8',
    title: 'آموزش متوسط Tailwind CSS',
    instructor: 'امیر رضایی',
    rating: 4.1,
    students: 670,
    price: 1200000,
