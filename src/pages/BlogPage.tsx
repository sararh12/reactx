              ...
              <div className="lg:w-3/4 lg:ml-8">
                  ...
                  {articles.map((article) => (
                    <div key={article.id} className="bg-white rounded-lg shadow-md overflow-hidden">
                      ...
                      <div className="p-4">
                        ...
                        <Link to={`/blog/${article.id}`} className="block text-luko-teal text-sm mt-4 hover:underline">
                          مطالعه بیشتر
                        </Link>
                      </div>
                    </div>
                ...
                <div className="mt-8 flex justify-center">
                  <div className="flex space-x-1 space-x-reverse">
                    ...
                    <button className="w-8 h-8 flex items-center justify-center rounded-md bg-luko-teal text-white">1</button>
                    ...
                    <button className="w-8 h-8 flex items-center justify-center rounded-md border border-gray-300">7</button>
                    <button className="w-8 h-8 flex items-center justify-center rounded-md border border-gray-300">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <div className="space-y-4">
                    {recommendedPosts.map((post) => (
                      <div key={post.id} className="flex border-b pb-4">
                        ...
                        />
                        <div className="mr-3">
                          <Link to={post.link} className="font-bold text-sm hover:text-luko-teal">
                            {post.title}
                          </Link>
                          <Link to={post.link} className="block text-xs text-luko-teal mt-2">
                            مطالعه مقاله
                          </Link>
                        </div>
                      </div>
                  ...
                  <div className="space-y-4">
                    {popularCourses.map((course) => (
                      ...
                      >
                        ...
                        <span className="mr-3 text-sm font-medium">{course.title}</span>
                    ...
                    <Link to="/courses" className="block text-center text-sm text-luko-teal hover:underline">
                      مشاهده همه دوره ها
                    </Link>
                  </div>
                </div>
