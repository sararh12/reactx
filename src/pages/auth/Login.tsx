...
import { setItem } from "@/services/common/storage.service";
      ...
      <div className="container mx-auto px-6 flex justify-center">
        <div className="w-full max-w-md">
          <div className="flex justify-between mb-8">
            <Link
              to="/"
              className="flex items-center text-gray-600 hover:text-gray-800 rtl"
            >
              <svg
              ...
              <div className="space-y-4">
                ...
                <div className="text-center mt-4">
                  <span className="text-sm text-gray-600">
                    ...
                    <Link
                      to="/auth/register"
                      className="text-luko-teal hover:underline font-medium"
                    >
                      ثبت نام کنید
                    </Link>
                  </span>
          ...
          <div className="mt-8 text-center">
            <div className="flex space-x-4 space-x-reverse justify-center">
              <Link
                to="mailto:info@luko.ir"
                className="bg-luko-teal text-white h-8 w-8 rounded-full flex items-center justify-center"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-4 w-4"
