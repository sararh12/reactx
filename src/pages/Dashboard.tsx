...
const Dashboard: React.FC = () => {
  ...
  // News and updates
  const news = [
    { id: '1', title: 'دوره آموزش جامع و پیشرفته NextJs منتشر شدند', date: '1402/02/30', isNew: true },
    { id: '2', title: 'تخفیف ویژه دوره‌های React را از دست ندهید', date: '1402/01/25' },
  ...
  const recommendedCourses = [
    { 
      id: '1', 
      title: 'آموزش کامل Figma', 
      instructor: 'مهدی محمدی', 
      image: 'public/lovable-uploads/6bf14711-f68d-471e-836c-44429cf7e00f.png'
    },
    { 
      id: '2', 
      title: 'آموزش کتابخانه های کاربردی JS', 
  ...
  const inProgressCourses = [
    { 
      id: '1', 
      title: 'آموزش جامع بک اند با PHP', 
    ...
    { 
      id: '2', 
      title: 'پکیج آموزش API های کاربردی', 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                  ...
                  <div className="flex justify-between items-center mb-6">
                    ...
                    <div className="flex-1 flex justify-center space-x-12 space-x-reverse">
                      <div className="text-center">
                        ...
                        <div className="mt-2">
                          <div className="font-bold text-xl">{user.purchasedCourses}</div>
                          <div className="text-sm text-gray-600">دوره خرید کرده اید</div>
                        </div>
                      </div>
                      ...
                      <div className="text-center">
                        ...
                        <div className="mt-2">
                          <div className="font-bold text-xl">{user.enrolledCourses}</div>
                          <div className="text-sm text-gray-600">شرکت کرده اید</div>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="border-t pt-4">
                  <h2 className="text-xl font-bold mb-4">جدید ترین اخبار و مقالات</h2>
                  <div className="space-y-4">
                    {news.map((item) => (
                      <div key={item.id} className={`border-b pb-2 ${item.isNew ? 'border-r-2 border-r-red-500 pr-2' : ''}`}>
                        <div className={`flex justify-between items-center ${item.isNew ? 'text-red-500' : ''}`}>
                          <Link to={`/blog/${item.id}`} className="hover:text-luko-teal">
                            {item.title}
                          </Link>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-white rounded-lg shadow-sm p-6">
                  ...
                  <div className="space-y-4">
                    {recommendedCourses.map((course) => (
                      <div key={course.id} className="border rounded-lg overflow-hidden">
                        <div className="aspect-w-3 aspect-h-2 bg-gradient-to-br from-purple-500 to-orange-400">
                        ...
                        <div className="p-4">
                          ...
                          <Link to={`/courses/${course.id}`} className="text-xs text-luko-teal hover:underline inline-flex items-center">
                  ...
                  <div className="mt-4 text-center">
                    <Link to="/courses" className="text-xs text-luko-teal hover:underline">
                      مشاهده همه
                    </Link>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-lg shadow-sm p-6">
                  <h2 className="text-lg font-bold mb-4">دوره های در حال برگزاری</h2>
                  <div className="space-y-4">
                      ...
                      <div key={course.id} className="border rounded-lg overflow-hidden">
                        ...
                        <div className="p-4">
                          ...
                          <div className="w-full h-1.5 bg-gray-200 rounded-full mb-2">
                            <div 
                              className="h-1.5 bg-luko-teal rounded-full" 
                  ...
                  <div className="mt-4 text-center">
                    <Link to="/dashboard/courses" className="text-xs text-luko-teal hover:underline">
                      مشاهده همه
                    </Link>
                  </div>
                </div>
            ...
            <div className="bg-luko-teal text-white rounded-lg shadow-sm overflow-hidden">
              ...
              <nav className="p-6 space-y-2 border-t border-luko-teal/20">
                ...
                <Link to="/dashboard/courses" className="flex items-center py-3 px-4 hover:bg-luko-teal/20 rounded-md">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                  </svg>
                  <span>دوره های من</span>
                </Link>
                <Link to="/dashboard/reserved" className="flex items-center py-3 px-4 hover:bg-luko-teal/20 rounded-md">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" />
                  </svg>
                  <span>دوره های رزرو شده</span>
                </Link>
                <Link to="/dashboard/comments" className="flex items-center py-3 px-4 hover:bg-luko-teal/20 rounded-md">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z" />
                  </svg>
                  <span>دیدگاه های من</span>
                </Link>
                <Link to="/dashboard/favorites" className="flex items-center py-3 px-4 hover:bg-luko-teal/20 rounded-md">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
                  </svg>
                  <span>علاقه مندی ها</span>
                </Link>
                <Link to="/dashboard/security" className="flex items-center py-3 px-4 hover:bg-luko-teal/20 rounded-md">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
